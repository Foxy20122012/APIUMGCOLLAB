...
export const updateCatedratico = async (req, res) => {
    ...
    const { nombre, apellido, correo, telefono, direccion, fecha_nacimiento, ocupacion, intereses, preferencias_notificacion, activo, email_verificado, telefono_verificado } = req.body;
